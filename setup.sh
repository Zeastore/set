...
IZIN=$( curl https://raw.githubusercontent.com/Zeastore/set/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
echo ""
wget -q https://raw.githubusercontent.com/Zeastore/set/main/dependencies
...
wget -q "https://raw.githubusercontent.com/Zeastore/set/main/xray/ins-xray.sh" && chmod +x ins-xray.sh && screen -S insxray ./ins-xray.sh
fi
wget -q "https://raw.githubusercontent.com/Zeastore/set/main/wireguard/wg.sh" && chmod +x wg.sh && screen -S wg ./wg.sh
wget -q "https://raw.githubusercontent.com/Zeastore/set/main/sstp/sstp.sh" && chmod +x sstp.sh && screen -S sstp ./sstp.sh
wget -q "https://raw.githubusercontent.com/Zeastore/set/main/ipsec/ipsec.sh" && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
wget -q "https://raw.githubusercontent.com/Zeastore/set/main/shadowsocks/ss.sh" && chmod +x ss.sh && screen -S ss ./ss.sh
wget -q "https://raw.githubusercontent.com/Zeastore/set/main/shadowsocks/ssr.sh" && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget -q "https://raw.githubusercontent.com/Zeastore/set/main/dll/system/set-br.sh" && chmod +x set-br.sh && screen -S sbr ./set-br.sh
#extension
clear
sleep 1
echo -e "[ ${green}INFO${NC} ] Downloading extension !!"
sleep 1
wget -q -O /usr/bin/xtls "https://raw.githubusercontent.com/Zeastore/set/main/xray/xtls.sh" && chmod +x /usr/bin/xtls && xtls && rm -f /usr/bin/xtls
...
wget -q -O /usr/bin/installbot "https://raw.githubusercontent.com/Zeastore/set/main/bot_panel/installer.sh" && chmod +x /usr/bin/installbot
wget -q -O /usr/bin/bbt "https://raw.githubusercontent.com/Zeastore/set/main/bot_panel/bbt.sh" && chmod +x /usr/bin/bbt
...
wget -q -O /usr/bin/.ascii-home "https://raw.githubusercontent.com/Zeastore/set/main/resources/ascii-home"
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Created By ZEASTORE ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
